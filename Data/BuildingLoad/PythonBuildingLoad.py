...
data_in=pd.read_csv('TradeStreetTotal.csv',parse_dates=['DateTime']); cal_real=3.5; cal_reactive=1; #Trade Street Warehouse
...
data_in.to_csv(f'../DemandPreprocessed/D-TradeStreetTotal.csv', index=False, header=True)
